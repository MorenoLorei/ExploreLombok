...
const Paketlabuanbajo = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                // Change this path to your new data file for Labuan Bajo
                const response = await fetch("/data/paketlabuan.json");
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="text-center mb-16">
                    <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4 tracking-tight">
                        PAKET WISATA LABUAN BAJO KOMODO
                    </h2>
                    <div className="w-24 h-1 bg-black mx-auto rounded-full"></div>
                    <p className="mt-6 text-lg text-gray-600 max-w-3xl mx-auto">
                        Jelajahi keindahan bawah laut dan pemandangan menakjubkan di Labuan Bajo dengan paket tur eksklusif kami
                    </p>
                </div>
...
export default Paketlabuanbajo;