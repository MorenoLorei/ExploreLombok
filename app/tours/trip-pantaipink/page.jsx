...
export default function TripPantaiPink() {
    return (
        <div className="max-w-5xl mx-auto p-6 bg-gray-50 min-h-screen font-sans text-gray-800">
            ...
            <div className="bg-white rounded-xl p-8 text-center mb-12 shadow-sm border border-gray-200">
                ...
                <p className="text-gray-600 text-lg leading-relaxed max-w-3xl mx-auto">
                    Nikmati salah satu dari tujuh pantai berpasir pink di dunia yang berlokasi di ujung timur Lombok. Rasakan ombak yang tenang dan pesona alam bawah laut yang menakjubkan.
                </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 mb-8 shadow-sm border border-gray-200">
                ...
                <ul className="list-disc list-inside space-y-2 text-gray-700 mb-6">
                    ...
                    <li>Pantai Pink 2</li>
                    <li>Bukit Tangsi</li>
                    <li>Gili Petelu ( Snorkling )</li>
                    <li>Gili Gambir ( Snorkling )</li>
                    <li>Pulau Pasir</li>
                </ul>
                ...
                <ul className="list-disc list-inside space-y-2 text-gray-700">
                    ...
                    <li>Menuju dermaga tanjung luar lombok timur untuk penyebrangan ke Pink Beach menggunakan private boat</li>
                    <li>Snorkling Trip di Gili Petelu,Gili gambir atau lokasi yang telah ditentukan oleh instruktur</li>
                    <li>Free and easy dan makan siang di Pink Beach 1 dan berfoto atau selfie di bukit tangsi</li>
                    <li>Lanjutkan Snorkling dan menuju Pink Beach 2,Pink Beach 3 ( Pantai berwarna Pink dan masih sangat alami )</li>
                    <li>Pulau Pasir yang sangat indah dan merupakan spot foto yang indah</li>
                    <li>Menuju mataram dan mengunjungi Pusat Olleh oleh Khas Lombok</li>
                    <li>Makan Malam di daerah mataram dan transfer hotel- Program selesai</li>
                </ul>
            </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-8">
                    <div>
                        ...
                        <div className="space-y-4">
                            <div className="bg-gray-100 p-4 rounded-lg">
                                <span className="font-bold text-gray-900">2 Orang:</span> Rp 675.000 / pack
                            </div>
                            <div className="bg-gray-100 p-4 rounded-lg">
                                <span className="font-bold text-gray-900">3-4 Orang:</span> Rp 460.000 / pack
                            </div>
                            <div className="bg-gray-100 p-4 rounded-lg">
                                <span className="font-bold text-gray-900">5-6 Orang:</span> Rp 385.000 / pack
                            </div>
                            <div className="bg-gray-100 p-4 rounded-lg">
                                <span className="font-bold text-gray-900">7-10 Orang:</span> Rp 365.000 / pack
                            </div>
                            <div className="bg-gray-100 p-4 rounded-lg">
                                <span className="font-bold text-gray-900">11-15 Orang:</span> Rp 290.000 / pack
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-gray-700 ml-4 list-disc">
                            ...
                            <li>Private boat Snorkling + Alat</li>
                            <li>1 X Makan Siang</li>
                            <li>Snack Box Tea and Coffe Time Beak</li>
                            <li>Air Mineral</li>
