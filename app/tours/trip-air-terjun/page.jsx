...
export default function TripAirTerjun() {
    return (
        <div className="max-w-5xl mx-auto p-6 bg-gray-50 min-h-screen font-sans text-gray-800">
            ...
            <div className="bg-white rounded-xl p-8 text-center mb-12 shadow-sm border border-gray-200">
                ...
                <h1 className="text-4xl md:text-5xl font-extrabold mb-6 text-gray-900 leading-tight">
                    Trip Air Terjun Tiu Kelep
                </h1>
                <p className="text-gray-600 text-lg leading-relaxed max-w-3xl mx-auto">
                    Nikmati keindahan dua air terjun terpopuler di bawah kaki Gunung Rinjani, Sendang Gile dan Tiu Kelep, dengan suasana hutan yang hijau dan alami.
                </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-8 mb-8 shadow-sm border border-gray-200">
                ...
                <div className="space-y-4 mb-6 text-gray-700">
                    <p>
                        Berada di Desa Senaru, Tiu Kelep merupakan air terjun terindah di Lombok Utara. Airnya yang jernih dan pemandangan alamnya yang menakjubkan menjadikannya destinasi favorit para petualang.
                    </p>
                    <p>
                ...
                <ul className="list-disc list-inside space-y-2 text-gray-700">
                    ...
                    <li>Soft trekking meyisiri pinggiran hutan Gunung Rinjani ke air terjun Sendang Gile (Air terjun pertama )</li>
                    <li>Soft trekking ke -2 meyisiri pinggiran hutan Gunung Rinjani ke air terjun Tiu Kelep ( Airterjun kedua ) -+ 25 menit sambil menikmati Flora dan Fauna yang berada di kawasan Geopark Rinjani</li>
                    <li>Kembali ke Basecamp untuk makan siang</li>
                    <li>Menuju ke Masjid Kuno Bayan ( Masjid pertama di pulau lombok )</li>
                    <li>Perjalanan dilanjutkan ke Pantai senggigi, bukit malaka, Villa hantu. Peserta bebas memilih objek wisata pantai untuk di singgahi</li>
                    <li>Kami akan mengantar anda kembali ke hotel atau lokasi yang telah ditentukan selesai makan malam.</li>
                </ul>
            </div>
                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            <div className="bg-gray-100 p-4 rounded-lg">
                                <span className="font-bold text-gray-900">2 Orang:</span> Rp 480.000 / pax
                            </div>
                            <div className="bg-gray-100 p-4 rounded-lg">
                                <span className="font-bold text-gray-900">3-4 Orang:</span> Rp 350.000 / pack
                            </div>
                            <div className="bg-gray-100 p-4 rounded-lg">
                                <span className="font-bold text-gray-900">5-6 Orang:</span> Rp 300.000 / pack
                            </div>
                            <div className="bg-gray-100 p-4 rounded-lg">
                                <span className="font-bold text-gray-900">7-10 Orang:</span> Rp 285.000 / pack
                            </div>
                            <div className="bg-gray-100 p-4 rounded-lg">
                                <span className="font-bold text-gray-900">11-15 Orang:</span> Rp 260.000 / pack
                            </div>
                        </div>
                    </div>
            ...
            <div className="text-center">
                <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-200">
                    <h3 className="text-xl font-bold mb-4 text-gray-800">Siap untuk Petualangan Air Terjun?</h3>
                    <p className="text-gray-600 mb-6">Hubungi kami untuk detail harga dan menyusun paket perjalanan Anda yang berkesan!</p>
                    <Link
                        href="https://wa.me/6285337452003?text=Halo%20Admin%ExploreLombok,%20saya%20tertarik%20dengan%20paket%20Trip%20Air%20Terjun%20Tiu%20Kelep"
                        target="_blank"
