            ...
            case "A":
                return (
                    <div className="space-y-8">
                        ...
                        <div>
                            <h3 className="text-lg font-semibold mb-3 text-pink-700">HARI 2. TRIP AIR TERJUN DESA SENARU, SENDANG GILA & TIU KELEP (B, L, D)</h3>
                            <ul className="list-disc list-inside space-y-2 text-gray-700">
                        ...
                        <div>
                            <h3 className="text-lg font-semibold mb-3 text-pink-700">HARI 3. CITY TOUR – AIRPORT (B, L)</h3>
                            <ul className="list-disc list-inside space-y-2 text-gray-700">
        ...
        if (activePackage === "no-hotel") {
            return (
                <ul className="space-y-2 text-gray-700 ml-4 list-disc">
                    ...
                    <li>Free makan 4x ( termasuk romantic dinner )</li>
            ...
            return (
                <ul className="space-y-2 text-gray-700 ml-4 list-disc">
                    ...
                    <li>Private transport antar jemput ( driver + bensin )</li>
                    <li>Tiket wisata</li>
                    <li>Free makan 5x ( termasuk romantic dinner)</li>
                    <li>Breakfast di hotel 2x</li>
        ...
        <div className="max-w-5xl mx-auto p-6 bg-gray-50 min-h-screen font-sans text-gray-800">
            ...
            <div className="bg-white rounded-xl p-8 mb-8 shadow-sm border border-gray-200">
                <h2 className="text-2xl font-bold mb-6 text-gray-800 border-b pb-2 border-gray-200">
                    {`Paket Honeymoon 3 Hari 2 Malam (${activePackage === "no-hotel" ? "Tanpa Hotel" : `Paket ${activePackage}`})`}
                </h2>
            ...
            <div className="text-center">
                <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-200">
                    ...
                    <Link
                        href="https://wa.me/6285337452003?text=Halo%20Admin%20Explore%20Lombok,%20Minta%20Info%20Paket%20Honeymoon%203%20Hari%202%20Malam"
                        target="_blank"
